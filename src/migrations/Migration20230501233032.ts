...
export class Migration20230501233032 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "dashboard" ("id" serial primary key, "created" timestamptz(0) not null, "updated" timestamptz(0) not null, "data_source_id" int not null, "metabase_id" int not null, "name" varchar(255) not null);');
