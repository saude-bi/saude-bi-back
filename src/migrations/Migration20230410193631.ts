...
export class Migration20230410193631 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "establishment" ("cnes" varchar(255) not null, "created" timestamptz(0) not null, "updated" timestamptz(0) not null, "name" varchar(255) not null, constraint "establishment_pkey" primary key ("cnes"));'
    )
